window.addEventListener('DOMContentLoaded', function(){
   ...
   /* for(let i = 0; i < 10; i++){
    ...
    $asideSection.addEventListener('onload', function(){

      })
    $asideSection.addEventListener('scroll', function(){

    })
    $asideSection.addEventListener('mouseover', function(){

    })
    $asideSection.addEventListener('onkeypress', function(){
